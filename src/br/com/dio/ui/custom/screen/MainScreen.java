...
import br.com.dio.input.NumberText;
...
public class MainScreen {
    ...
    public void buildMainScreen(){
        ...
        for (int r = 0; r < 9; r+=3) {
            ...
            for (int c = 0; c < 9; c+=3) {
                var endCol = c + 2;
                var space = getSpacesFromSector(boardService.getSpaces(), c, endCol, r, endRow);
                JPanel sector = geenerateSection(space);
    ...
    private JPanel geenerateSection(final List<Space> spaces){
    ...
    private void addFinishGameButton(final JPanel mainPanel) {
         finishGameButton = new FinishGameButton(e->{
            if(boardService.gameIsFinished()){
                ...
                var message = "O seu jogo tem alguma inconsistência, ajuste e tenta novamente";
    ...
    private void addCheckGameStatusButton(final JPanel mainPanel) {
        ...
        checkGameStatusButton = new CheckGameStatusButton(e->{
            ...
            var message = switch (gameStatus){
                case NON_START -> "O jogo não foi iniciado";
    ...
    private void addResetButton(final JPanel mainPanel) {
        resetButton = new ResetButton(e ->{
            var dialogResult = JOptionPane.showConfirmDialog(null,"Deseja realmente reiniciar o jogo","Limpar o jogo",
